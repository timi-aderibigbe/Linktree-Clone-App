...
import ProfileImage from "../src/img/timipic.jpg";
...
function App() {
  const buttons = [
    {
      ...
      href: "https://twitter.com/timi_sol",
      id: "twitter",
    },
    {
      linkName: "Zuri Team",
    ...
    },
    {
      ...
      href: "https://books.zuri.team/python-for-beginners?ref_id=Col.Mustard",
      id: "book__python",
    },
    {
  ...
  return (
    ...
    <div className="container w-30 flex flex-col sm-auto justify-center items-center">
      ...
      <h1 className="text-2xl py-4 font-bold">Aderibigbe Oluwatimilehin</h1>
      ...
      <div className="flex">
        ...
        <a href="https://github.com/timi-aderibigbe" id="github">
          <img
            src={Github}
            alt="github"
            className="w-8 rounded-full border-sky-500 m-2"
